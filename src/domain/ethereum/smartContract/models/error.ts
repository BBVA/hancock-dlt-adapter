...
export const hancockContractRegisterError = new HancockError('50012', 500, 'Smart Contract - Register Error');
export const hancockContractUpdateVersionError = new HancockError('50013', 500, 'Smart Contract - Update Version Error');
export const hancockContractUpdateAbiVersionError = new HancockError('50014', 500, 'Smart Contract - Update Abi Version Error');
export const hancockContractRetrieveError = new HancockError('50015', 500, 'Smart Contract - Retrieve Error');
