...
const TransactionDeployModel = require(`${schemaPath}/requests/ethereum/smartContracts/transactionDeploy.json`);
const TransactionInvokeModel = require(`${schemaPath}/requests/ethereum/smartContracts/transactionInvoke.json`);
const RegisterSmartContractModel = require(`${schemaPath}/requests/ethereum/smartContracts/register.json`);
const TransactionInvokeParamModel = require(`${schemaPath}/requests/ethereum/smartContracts/transactionInvokeByParam.json`);
