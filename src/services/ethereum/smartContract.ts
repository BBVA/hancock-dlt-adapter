...
import * as ResponsesSmartContract from '../../routes/ethereum/smartcontracts/smartContractResponses';
const ACTIONS = {
  CALL: 'call',
  SEND: 'send',
};
...
exports.retrieveContractAbi = (contractData: any) => {
...
exports.adaptContractInvoke = (contractData: any) => {
