...
module.exports = {
  ...
  bad_request: {
    ...
    message: 'Addresses - Bad request'
  },

  internal_ddbb_error: {
    statusCode: 500,
    code: responses.kstgeneral500.code,
    message: 'Addresses - Internal ddbb error'
  },

  eth_web3_error: {
  	statusCode: 512,
  	code: responses.ksteth512.code,
  	message: 'Addresses - Ethereum web3 error'
  },

  eth_web3_ok: {
  	statusCode: 200,
  	code: responses.ksteth200.code,
  	message: 'Addresses - Ethereum web3 operation successful'
  }
